...
- `default`: Complicated; see [docs](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/where-generic-type-constraint) for details (todo explain here)
