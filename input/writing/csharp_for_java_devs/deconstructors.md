You can create a deconstructor for a class by creating the method `Deconstruct`. All parameters must be `out`. You can have as many overloads of `Deconstruct` as you want, but they must all have different argument counts
