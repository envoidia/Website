Structs, unlike classes, are value types, meaning they do not have object headers, are passed by value, and are allocated on the stack rather than the heap (unless part of a [collection](./collections))
...
Most programmers will never create their own struct, but it's important to understand how the ones in libraries you're using work
...
todo struct marshalling info, union info

Also see: [Classes](./classes), [Enums](./enums), [Extensions](./extensions), [Interfaces](./interfaces), [Object Initializers](./object_initializers)
